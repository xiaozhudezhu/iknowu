...
package com.swinginwind.core.spring.mvc.method.annotation;
...
import com.swinginwind.core.spring.mvc.util.MapWapper;
            ...
            if(paramValues.length == 1) {
                ...
                if(MapWapper.class.isAssignableFrom(paramType)) {
                    ...
                    if(type instanceof ParameterizedType) {
                        mapType = (MapType) mapType.withTypeHandler((Class<?>)((ParameterizedType)type).getActualTypeArguments()[0]);
                        mapType = (MapType) mapType.withContentTypeHandler((Class<?>)((ParameterizedType)type).getActualTypeArguments()[1]); 
                    }
                ...
                if(Collection.class.isAssignableFrom(paramType)) {
                    javaType = javaType.withContentTypeHandler((Class<?>)((ParameterizedType)type).getActualTypeArguments()[0]);                        
                }
